...
void evaluate_M2P_and_P2P(std::vector<Particle> &particles, unsigned int p, unsigned int i,
   std::vector<Cell> &cells, std::vector<double> &F, unsigned int n_crit, double theta,
...
void evaluate_approx(std::vector<Particle> &particles, std::vector<Cell> &cells, std::vector<double> &F, unsigned int n_crit, double theta, unsigned int exp_order) {
