...
public:
  unsigned int
      nleaf;           /*!< \brief Number of particles held in cell.
  ...
  unsigned int
      level; /*!< \brief Level of the tree that the cell sits at.
  ...
  std::vector<unsigned int>
      leaf;            /*!< \brief Indices of particles in the cell. */
  ...
  Cell(double x, double y, double z, double r, unsigned int parent,
