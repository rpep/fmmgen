...
int main(int argc, char **argv) {
  ...
  for(unsigned int order = 1; order < maxorder; order++) {
    ...
    std::cout << "M2M Check" << std::endl;
    std::cout << "---------" << std::endl;
    std::cout << cells[0].M[1] << ", " << mux_total << std::endl;
    std::cout << cells[0].M[2] << ", " << muy_total << std::endl;
    std::cout << cells[0].M[3] << ", " << muz_total << std::endl;
    ...
    for (unsigned int i = 0; i < particles.size(); i++) {
      // std::cout << F_exact[4*i] << ", " << F_approx[4*i] << std::endl;
    ...
    std::cout << std::setw(10) << t2/t1 * 100 << "% of direct time." << std::endl;
