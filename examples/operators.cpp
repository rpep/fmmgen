...
#pragma omp atomic
F[0] += (-Ftmp0*Ftmp1*x - Ftmp0*Ftmp2*y - Ftmp0*Ftmp3*z + Ftmp10*Ftmp9 - Ftmp14*(1.0 - Ftmp13) - Ftmp17*(1.0 - Ftmp16) - Ftmp20*(1.0 - Ftmp19) + Ftmp5*Ftmp7 + Ftmp8*Ftmp9 + M[0])/R;
#pragma omp atomic
...
double Dtmp10 = (z*z);
double Dtmp11 = 15.0*Dtmp3;
double Dtmp12 = -Dtmp11*Dtmp2;
double Dtmp13 = Dtmp5*(Dtmp12 + 3.0);
double Dtmp14 = -Dtmp11*Dtmp8;
double Dtmp15 = Dtmp14 + 3.0;
double Dtmp16 = 1.0*Dtmp6;
double Dtmp17 = -Dtmp10*Dtmp11;
double Dtmp18 = Dtmp17 + 3.0;
double Dtmp19 = Dtmp5*z;
D[0] = (1 / (R));
D[1] = -Dtmp1*x;
D[2] = -Dtmp1*y;
D[3] = -Dtmp1*z;
...
D[8] = 3.0*Dtmp9*z;
D[9] = Dtmp0*(Dtmp10*Dtmp4 - 1.0);
D[10] = Dtmp6*(Dtmp12 + 9.0);
D[11] = Dtmp13*y;
D[12] = Dtmp13*z;
D[13] = Dtmp15*Dtmp16;
D[14] = -15.0*x*y*z/pow(R, 7);
D[15] = Dtmp16*Dtmp18;
D[16] = Dtmp9*(Dtmp14 + 9.0);
D[17] = Dtmp15*Dtmp19;
D[18] = 1.0*Dtmp18*Dtmp9;
D[19] = Dtmp19*(Dtmp17 + 9.0);
#pragma omp atomic
...
#pragma omp atomic
F[0] += (-Ftmp0*Ftmp1*x - Ftmp0*Ftmp2*y - Ftmp0*Ftmp3*z + 3.0*Ftmp10*M[8] - Ftmp11*Ftmp13*x - Ftmp17*(1.0 - Ftmp16) - Ftmp20*(1.0 - Ftmp19) - Ftmp23*(1.0 - Ftmp22) + Ftmp27*Ftmp5 + Ftmp28*Ftmp29 + Ftmp28*Ftmp33*M[12] + Ftmp32*Ftmp9 + Ftmp33*Ftmp34*M[17] + Ftmp33*Ftmp37 + Ftmp34*Ftmp39 + Ftmp40*Ftmp41 + Ftmp40*Ftmp43 + Ftmp6*Ftmp7 + Ftmp6*Ftmp8 + M[0])/R;
#pragma omp atomic
...
double Dtmp14 = Dtmp13*Dtmp5;
double Dtmp15 = -Dtmp11*Dtmp8;
double Dtmp16 = Dtmp15 + 3.0;
double Dtmp17 = 1.0*Dtmp6;
double Dtmp18 = pow(R, -7);
double Dtmp19 = Dtmp18*y;
double Dtmp20 = Dtmp19*z;
double Dtmp21 = -Dtmp10*Dtmp11;
double Dtmp22 = Dtmp21 + 3.0;
double Dtmp23 = Dtmp5*z;
double Dtmp24 = 105.0/(R*R*R*R);
double Dtmp25 = Dtmp2*Dtmp3;
double Dtmp26 = -105.0*Dtmp25;
double Dtmp27 = x*(Dtmp26 + 45.0);
double Dtmp28 = Dtmp18*z;
double Dtmp29 = Dtmp2*Dtmp24;
double Dtmp30 = 105.0*Dtmp3;
double Dtmp31 = -Dtmp30*Dtmp8;
double Dtmp32 = Dtmp31 + 45.0;
double Dtmp33 = 1.0*x;
double Dtmp34 = Dtmp28*Dtmp33;
double Dtmp35 = Dtmp10*Dtmp3;
double Dtmp36 = -Dtmp10*Dtmp30 + 45.0;
D[0] = (1 / (R));
D[1] = -Dtmp1*x;
D[2] = -Dtmp1*y;
D[3] = -Dtmp1*z;
...
D[14] = -15.0*Dtmp20*x;
D[15] = Dtmp17*Dtmp22;
D[16] = Dtmp9*(Dtmp15 + 9.0);
D[17] = Dtmp16*Dtmp23;
D[18] = 1.0*Dtmp22*Dtmp9;
D[19] = Dtmp23*(Dtmp21 + 9.0);
D[20] = Dtmp5*(Dtmp24*(x*x*x*x) - 90.0*Dtmp25 + 9.0);
D[21] = -Dtmp19*Dtmp27;
D[22] = -Dtmp27*Dtmp28;
D[23] = Dtmp5*(Dtmp13 + Dtmp15 + Dtmp29*Dtmp8);
D[24] = -Dtmp20*(Dtmp26 + 15.0);
D[25] = Dtmp5*(Dtmp10*Dtmp29 + Dtmp13 + Dtmp21);
D[26] = -Dtmp19*Dtmp32*Dtmp33;
D[27] = -Dtmp34*(Dtmp31 + 15.0);
D[28] = -3.0*Dtmp19*x*(5.0 - 35.0*Dtmp35);
D[29] = -Dtmp34*Dtmp36;
D[30] = Dtmp5*(Dtmp24*(y*y*y*y) - 90.0*Dtmp3*Dtmp8 + 9.0);
D[31] = -Dtmp20*Dtmp32;
D[32] = Dtmp5*(Dtmp10*Dtmp24*Dtmp8 + Dtmp16 + Dtmp21);
D[33] = -1.0*Dtmp20*Dtmp36;
D[34] = Dtmp5*(Dtmp24*(z*z*z*z) - 90.0*Dtmp35 + 9.0);
#pragma omp atomic
...
double Ftmp46 = (5.0 - 35.0*Ftmp45)*M[28];
